...
#   ✓ Correct S3 training path
#   ✓ Separate TRAIN / TEST directories
#   ✓ No expected row-count checks
#   ✓ No lower-row-count warnings/flags
#   ✓ Processes whatever rows are present
#   ✓ DuckDB for million-row data
#   ✓ Live heartbeat during long SQL operations
#   ✓ Optimized exact blocking
#   ✓ Optimized house+locality / house+city blocking
...
# ------------------------------------------------------------
# TF-IDF only for S1 rows with fewer deterministic candidates
# ------------------------------------------------------------
...
# ============================================================
#
# ONLY checks whether the files exist.
#
# NO expected-row-count check.
# ============================================================
...
# ============================================================
# 6. REMOVE PREVIOUS DUCKDB DATABASE
# ============================================================
...
if os.path.exists(DB_PATH):
    ...
    try:
        ...
        raise RuntimeError(
            "\nThe previous Stage-4 DuckDB database "
            "is still locked.\n"
            "Stop the previous Colab execution and "
            "run this cell again."
        )
...
def execute_with_heartbeat(
    ...
    """
    Executes a DuckDB query while printing elapsed time.
    """
...
# ============================================================
# 20. CREATE COMPACT FEATURE TABLES
# ============================================================
...
def add_exact_block(
    ...
    FROM
        {sql_ident(s1_table)} a


    INNER JOIN
        {sql_ident(sx_table)} b
...
# ============================================================
# 26. OPTIMIZED HOUSE / LOCALITY / CITY BLOCK
# ============================================================
...
def run_tfidf_block(
    ...
    # --------------------------------------------------------
    # Bucket = country + first 2 Roman chars
    # --------------------------------------------------------
    ...
    for bucket_number, bucket in enumerate(
        ...
        # ----------------------------------------------------
        # Get source rows for the bucket
        # ----------------------------------------------------
        ...
        try:
            ...
            # ------------------------------------------------
            # Convert nearest neighbors into candidates
            # ------------------------------------------------
...
# ============================================================
# 37. PER-STRATEGY BLOCKING RECALL
# ============================================================
...
# ============================================================
# 40. FINAL SUBMISSION CANDIDATE FILE
# ============================================================
